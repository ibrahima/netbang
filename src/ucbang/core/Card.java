...
public class Card {
    ...
    public static enum play{DAMAGE, HEAL, MISS, DRAW, STEAL, DISCARD, DUEL, JAIL}; //played cards
    public static enum field{DAMAGE, HEAL, MISS, DRAW, STEAL, DISCARD, BARREL, DYNAMITE, GUN, HORSE_RUN, HORSE_CHASE}; //field cards
    ...
    public Card(Enum e) {
        ...
        if(e instanceof Bang.Characters){
            ...
            switch((Bang.CardName)e){
                ...
                case BANG: type = 2; special = 1; range = 1; target = 2; effect = play.DAMAGE.ordinal(); break;
                ...
                case PEPPERBOX: type = 3; target = 2; range = 1; effect = play.DAMAGE.ordinal(); break; //TODO: make same range as bang
                case DERRINGER: type = 3; target = 2; range = 1; effect = play.DAMAGE.ordinal(); effect2 = play.DRAW.ordinal(); break;
                
                case DUEL: type = 2; target = 2; range = -1; effect = play.DUEL.ordinal(); break;
                case DYNAMITE: type = 3; target = 1; effect = field.DYNAMITE.ordinal(); break;
                
                case MISS: type = 4; special = 1; effect = play.MISS.ordinal(); break;
                case DODGE: type = 4; effect = play.MISS.ordinal(); break;
                case BIBLE: type = 4; effect = play.MISS.ordinal(); break;
                case IRON_PLATE: type = 3; effect = play.MISS.ordinal(); break;
                case SOMBRERO: type = 3; effect = play.MISS.ordinal(); break;
                case TEN_GALLON_HAT: type = 3; effect = play.MISS.ordinal(); break;
            
                case BARREL: type = 3; effect = field.BARREL.ordinal(); break;
                ...
                case APPALOOSA: type = 3; effect = field.HORSE_CHASE.ordinal(); break;
                case SILVER: type = 3; effect = field.HORSE_CHASE.ordinal(); break;
                case MUSTANG: type = 3; effect = field.HORSE_RUN.ordinal(); break;
                case HIDEOUT: type = 3; effect = field.HORSE_RUN.ordinal(); break; //you heard me: a hideout is a horse.
                ...
                case CAT_BALLOU: type = 2; target = 2; range = -1; effect = play.DISCARD.ordinal(); break;
                
                case VOLCANIC: type = 3; special = 1; range = 1; effect = field.GUN.ordinal(); break;
                case SCHOFIELD: type = 3; range = 2; effect = field.GUN.ordinal(); break;
                case REMINGTON: type = 3; range = 3; effect = field.GUN.ordinal(); break;
                case REV_CARBINE: type = 3; range = 4; effect = field.GUN.ordinal(); break;
                case WINCHESTER: type = 3; range = 5; effect = field.GUN.ordinal(); break;
